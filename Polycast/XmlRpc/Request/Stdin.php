 ...
 *
 * Extends {@link Polycast_XmlRpc_Request} to accept a request via STDIN. Request is
 ...
 */
class Polycast_XmlRpc_Request_Stdin extends Polycast_XmlRpc_Request
{
    /**
    ...
    public function __construct()
    {
        ...
        if (!$fh) {
            $this->_fault = new Polycast_XmlRpc_Server_Exception(630);
            return;
        }
