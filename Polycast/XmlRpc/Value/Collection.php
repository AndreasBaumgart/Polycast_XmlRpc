 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Polycast_XmlRpc_Value_Collection extends Polycast_XmlRpc_Value
{
    ...
    public function __construct($value)
    {
        ...
        foreach ($values as $key => $value) {
            // If the elements of the given array are not Polycast_XmlRpc_Value objects,
    ...
    public function getValue()
    {
        ...
        foreach ($values as $key => $value) {
            /* @var $value Polycast_XmlRpc_Value */
