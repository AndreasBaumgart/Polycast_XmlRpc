 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Polycast_XmlRpc_Server_Fault extends Polycast_XmlRpc_Fault
{
    /**
     * @var Exception
     */
     ...
     */
    protected static $_faultExceptionClasses = array('Polycast_XmlRpc_Server_Exception' => true);
    ...
    /**
     * Return Polycast_XmlRpc_Server_Fault instance
     *
     * @param Exception $e
     * @return Polycast_XmlRpc_Server_Fault
     */
