 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Polycast_XmlRpc_Client_ServerIntrospection
{
    /**
     * @var Polycast_XmlRpc_Client_ServerProxy
     */
    private $_system = null;


    /**
     * @param Polycast_XmlRpc_Client $client
     */
    public function __construct(Polycast_XmlRpc_Client $client)
    {
    ...
    public function getSignatureForEachMethod()
    {
        ...
        } catch (Polycast_XmlRpc_Client_FaultException $e) {
            // degrade to looping
        }
    ...
    public function getSignatureForEachMethodByMulticall($methods = null)
    {
        ...
        if (! is_array($serverSignatures)) {
            ...
            require_once 'Polycast/XmlRpc/Client/IntrospectException.php';
            throw new Polycast_XmlRpc_Client_IntrospectException($error);
        }
